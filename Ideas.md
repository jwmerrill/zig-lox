...
- [x] In the book implementation, collecting garbage can fail with OOM because it needs to grow the gray stack as part of its operations. Avoid this by making the gray stack an intrusive linked list stored on the objects themselves.
